...
// without a mailbox; the workspace it creates lives in the
...
export function GET(request: NextRequest) {
  ...
  if (process.env.COURSE_CONTEXT_E2E_FIXTURE !== "true" || process.env.NODE_ENV === "production") return NextResponse.redirect(new URL("/login", origin))
