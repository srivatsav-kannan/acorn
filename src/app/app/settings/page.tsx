...
export default function Page() {
  ...
  return <AppShell activePage="settings" quarter="Autumn 2026" activity={value.workspace.activity} onUndo={value.undo}><div className="page settings-page">
    <header className="page-heading"><div><p className="eyebrow">Your information</p><h1>Settings</h1><p>Change what CourseContext remembers about you and your planning.</p></div>{value.mode === "demo" ? <button className="secondary-button" onClick={value.reset}>Reset demo</button> : <button className="secondary-button" onClick={value.signOut}>Sign out</button>}</header>
