...
export const AgentConnectionPage = ({ workspace }: { workspace: WorkspaceState }) => {
  ...
  return <div className="page agent-page agent-rebuild">
    ...
    <section className="agent-conversation-guide">
      ...
      <div className="agent-permissions"><p className="eyebrow">What your agent can do</p><ul><li><span>✓</span><div><strong>Read what you saved</strong><small>Goals, preferences, plans, notes, and sources.</small></div></li><li><span>✓</span><div><strong>Research and organize</strong><small>New sources are saved visibly with attribution.</small></div></li><li><span>✓</span><div><strong>Edit plans</strong><small>Changes are focused, persisted, and undoable.</small></div></li><li className="blocked"><span>×</span><div><strong>No external submissions</strong><small>It cannot enroll, send email, or act in Stanford systems.</small></div></li></ul></div>
    </section>
