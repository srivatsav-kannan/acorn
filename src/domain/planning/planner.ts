import { isEvidenceStale } from "@/domain/workspace/evidence"
import { effectiveCompletedCourseIds } from "@/domain/workspace/history"
import type { Activity, Catalog, Evidence, Meeting, PlanScenario, StudentProfile } from "@/domain/workspace/types"
