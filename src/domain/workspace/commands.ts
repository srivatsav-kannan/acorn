...
import { validateContextItem } from "@/domain/workspace/context"
import { upsertResearchLibraryItem, validateEvidence } from "@/domain/workspace/evidence"
import { applyAcademicHistory, validateAcademicHistoryPatch } from "@/domain/workspace/history"
import { emptyOverlay, validateOpportunity, validateOverlayCourse, validateOverlaySection, validateReferenceProgram } from "@/domain/workspace/reference"
import { assertSafeExternalUrl } from "@/domain/workspace/security"
import { isValidTimezone } from "@/domain/planning/timezone"
import { compareTerms, parseTermId, supportsTimeline, termLabel } from "@/domain/planning/timeline"
import { validateSavedView } from "@/domain/workspace/views"
import type { ActionReceipt, Actor, ChangedEntity, ContextItem, Preference, WorkspaceState } from "@/domain/workspace/types"
