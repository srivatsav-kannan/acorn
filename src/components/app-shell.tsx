  ...
  return <div className="app-frame">
    ...
    <header className="topbar">
      ...
      <div className="topbar-actions">
        {workspaceValue && <span className={`save-indicator ${workspaceValue.saveState}`} aria-live="polite"><i />{workspaceValue.saveState === "saving" ? "Saving" : workspaceValue.saveState === "error" ? "Not saved" : workspaceValue.mode === "demo" ? "Saved locally" : "Saved"}</span>}
