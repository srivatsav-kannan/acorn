...
const personalWorkspaceBuilder = readFileSync(resolve(process.cwd(), "src/data/workspace/personal-workspace.ts"), "utf8")
...
const commandEngine = readFileSync(resolve(process.cwd(), "src/domain/workspace/commands.ts"), "utf8")
