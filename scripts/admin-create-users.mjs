...
//
//   node scripts/admin-create-users.mjs user@example.com Password123 [more pairs...]
...
if (!pairs.length) {
  console.error("Usage: node scripts/admin-create-users.mjs email password [email password ...]")
  process.exit(1)
}
